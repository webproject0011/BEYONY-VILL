...
# 2. UI Styling with Forced Downward Suggestions & Extra Brightness
st.markdown("""
    <style>
    /* Full Page Background with Extra Brightness */
    .stApp {
    ...
    /* FIX: Force Suggestions Downwards & High Visibility */
    div[data-baseweb="popover"] {
        top: 60px !important; /* Forces it to start below search bar */
        bottom: auto !important;
    }
    
    /* Search Bar Professionalism */
    div[data-baseweb="select"] > div {
        background-color: rgba(255, 255, 255, 0.25) !important; /* Brighter Bar */
...
with m:
    ...
    if q:
        ...
        if res.data:
            ...
            # This dropdown will now always open DOWNWARDS
